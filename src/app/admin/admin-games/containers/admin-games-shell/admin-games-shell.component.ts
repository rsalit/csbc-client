...
import * as gameActions from '../../../../games/state/games.actions';import { Store } from '@ngrx/store';
...
@Component({
  ...
  styleUrls: ['./admin-games-shell.component.scss', '../../../admin.component.scss']
})
export class AdminGamesShellComponent implements OnInit {

  constructor(private store: Store<fromGames.State>, private gameService: GameService) { }
